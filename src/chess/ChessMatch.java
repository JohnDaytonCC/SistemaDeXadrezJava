...
public class ChessMatch {
	...
	public ChessMatch() {
		...
		//check = false;	// Por padrão a variável boleana inicia com falso, foi introduzido apenas para enfatizar o valor da inicialização.
		initialSetup();
	}
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		if(!type.equals("B") && !type.equals("D") && !type.equals("T") && !type.equals("C")) {
			return promoted;
		}
	...
	private Piece makeMove(Position source, Position target) {
		...
		// Tratamento do movimento especial: Roque Maior
		if(p instanceof King && target.getColumn() == source.getColumn() - 2) {
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		// Desfazendo o movimento especial: Roque Pequeno
		if(p instanceof King && target.getColumn() == source.getColumn() + 2) {
			Position sourceT = new Position(source.getRow(), source.getColumn() + 3);
			Position targetT = new Position(source.getRow(), source.getColumn() + 1);
		...
		// Desfazendo o movimento especial: Roque Maior
		if(p instanceof King && target.getColumn() == source.getColumn() - 2) {
			Position sourceT = new Position(source.getRow(), source.getColumn() - 4);
			Position targetT = new Position(source.getRow(), source.getColumn() - 1);
			ChessPiece rook = (ChessPiece)board.removePiece(targetT);
